...
namespace Gameplay {
	...
	void GameObject::SetPositionX(const float value) {
		_position.x = value;
		_isTransformDirty = true;
	}
	void GameObject::SetPositionY(const float value) {
		_position.y = value;
		_isTransformDirty = true;
	}
	void GameObject::SetPositionZ(const float value) {
		_position.z = value;
		_isTransformDirty = true;
	}
	...
	void GameObject::SetRotationX(const float value) {
		_rotation.x = value;
		_isTransformDirty = true;
	}

	void GameObject::SetRotationY(const float value) {
		_rotation.y = value;
		_isTransformDirty = true;
	}

	void GameObject::SetRotationZ(const float value) {
		_rotation.z = value;
		_isTransformDirty = true;
	}
